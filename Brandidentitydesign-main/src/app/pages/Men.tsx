  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.hero}>
        <h1 className={styles.title}>Crafted for the Conscious Man</h1>
        <p className={styles.subtitle}>
          Refined Western cuts embedded with ancient handwork. Thoughtful details, sustainable
          tailoring, and slow fashion designed to last.
        </p>
      </section>
